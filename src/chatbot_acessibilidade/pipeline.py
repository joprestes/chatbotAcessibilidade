"""
Pipeline de Acessibilidade - Wrapper de Compatibilidade.

Este módulo mantém a função pipeline_acessibilidade() como wrapper compatível
que usa internamente o PipelineOrquestrador melhorado.
"""
