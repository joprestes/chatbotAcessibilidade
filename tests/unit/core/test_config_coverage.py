...
def test_huggingface_models_list_quando_e_string():
    """
    Testa linha 127: quando huggingface_models é string,
    deve chamar parse_huggingface_models
    """
    with patch.dict(
        os.environ,
        {
        ...
        settings = Settings()
        # huggingface_models é string, então linha 127 deve ser executada
...
def test_config_linhas_150_153_sem_google_api_key():
    ...
    original_openrouter_key = os.environ.pop("HUGGINGFACE_API_KEY", None)
    ...
    try:
        ...
        if original_openrouter_key:
            os.environ["HUGGINGFACE_API_KEY"] = original_openrouter_key
...
def test_config_linhas_150_153_sem_openrouter_api_key():
    ...
    e HUGGINGFACE_API_KEY não está em os.environ
    """
    # Remove PYTEST_CURRENT_TEST temporariamente para testar o bloco
    original_pytest = os.environ.pop("PYTEST_CURRENT_TEST", None)
    original_google_key = os.environ.pop("GOOGLE_API_KEY", None)
    ...
    try:
        ...
        # Remove HUGGINGFACE_API_KEY para testar linha 152-153
        ...
        # Verifica que HUGGINGFACE_API_KEY foi definido como string vazia
        assert "HUGGINGFACE_API_KEY" in os.environ
        assert os.environ["HUGGINGFACE_API_KEY"] == ""
        ...
        if original_openrouter_key:
            os.environ["HUGGINGFACE_API_KEY"] = original_openrouter_key
        elif "HUGGINGFACE_API_KEY" in os.environ and os.environ["HUGGINGFACE_API_KEY"] == "":
            del os.environ["HUGGINGFACE_API_KEY"]
