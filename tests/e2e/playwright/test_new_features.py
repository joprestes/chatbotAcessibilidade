...
def test_persona_selection_flow(page: Page):
    ...
    expect(input_area).to_have_value("/simular leitor-tela Estou tentando comprar um ingresso, mas o leitor de tela não anuncia o preço quando navego pela tabela de assentos.")
